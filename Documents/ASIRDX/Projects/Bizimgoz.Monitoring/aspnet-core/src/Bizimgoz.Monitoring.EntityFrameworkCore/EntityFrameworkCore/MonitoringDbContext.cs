...
public class MonitoringDbContext :
    AbpDbContext<MonitoringDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    /* Add DbSet properties for your Aggregate Roots / Entities here. */

    public DbSet<ZabbixHost> Hosts { get; set; }
    public DbSet<TopologyEdge> TopologyEdges { get; set; }
    public DbSet<TopologyNode> TopologyNodes { get; set; }
    public DbSet<TelegramUser> TelegramUsers { get; set; }
    public DbSet<ZabbixInfo> ZabbixInformations { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(MonitoringConsts.DbTablePrefix + "YourEntities", MonitoringConsts.DbSchema);
